...
class SpanManagerService {
  ...
  endSpan(params: EndSpanParams) {
    ...
    // fix: If it's not in the current entity, delete from the root entity.
...
export const currentEntity = spanManagerService.getModelSpanEntity.bind(spanManagerService)
